...
class WriteFolder {
     ...
     */
    constructor(createdAt, id, createdBy, type, userPermission, groupsPermissions, name, nature, updatedAt) { 
        
        WriteFolder.initialize(this, createdAt, id, createdBy, type, userPermission, groupsPermissions, name, nature, updatedAt);
    }
     ...
     */
    static initialize(obj, createdAt, id, createdBy, type, userPermission, groupsPermissions, name, nature, updatedAt) { 
